...
class Admin:
    ...
    def view_rooms(self):
        ...
        print(
            f"{'room_id':<10} {'room_no':<10} {'category':<20} {'rate_per_day':<15} {'occupancy_status':<20} {'hourly_rate':<10}")

        for room in rooms:
            room_id, room_no, category, rate_per_day, occupancy_status, hourly_rate = room
            print(
                f"{room_id:<10} {room_no:<10} {category:<20} {rate_per_day:<15.2f} {occupancy_status:<20} {hourly_rate if hourly_rate is not None else 'N/A':<10}")

    def view_occu_rooms(self):
        cursor = self.db_connection.cursor()
...
class Customer:
    ...
    def pay(self, room_no, customer_id, no_of_days, advance):
        cursor = self.db_connection.cursor()
            ...
            if admin.admin_login(user_id, password):
                while True:
                    ...
                    if choice == 1:
                        ...
                        admin.view_occu_rooms()
                    elif choice == 4:
                        booking_id = input("Enter booking ID: ")
                        admin.search_by_id(booking_id)
                    elif choice == 5:
                        admin.view_unocc_rooms()
                    elif choice == 6:
                        ...
                        while True:
                            ...
                            if choice == 1:
                                ...
                                if room_no:
                                    ...
                                    customer.pay(room_no, customer_id, no_of_days, advance)
                                else:
